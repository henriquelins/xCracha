...
public class PesquisarComboBox extends PlainDocument {
    /**
	 * 
	 */
	private static final long serialVersionUID = -8378298245429124190L;
	JComboBox<?> comboBox;
    ComboBoxModel<?> model;
    ...
    public PesquisarComboBox(final JComboBox<?> comboBox) {
